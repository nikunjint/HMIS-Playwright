...
const ViewEditdMenu = ({ open, setOpen }) => {
            ...
            <div className="m-auto grid w-full items-center gap-x-4 md:grid-cols-12">
              ...
              <div className="col-span-4">
                <Common.Inputs
                  ...
                  initialValue={open.data?.organization_by}
                  readOnly={true}
                  hidelabel
                  prefix={"Organization By :"}
                  bordered={true}
                />
              </div>
              <div className="col-span-4">
                <Common.Inputs
                  name="suborganization_by"
                  initialValue={open.data?.suborganization_by}
                  readOnly={true}
                  hidelabel
                  prefix={"Sub Organization By :"}
                  bordered={true}
                />
              </div>
              <div className="col-span-4">
