...
import ViewEditdFeatures from "./ViewEdit";
  ...
  const columns = [
...

    {
      ...
      render:(_,record)=>(
        ...
        <Common.AntAction action={Action} data={record}  setOpen={(e)=>setOpen(e)} title="Features"/>
        </div>
      )
    },
  ];
  return (
    <div className="grid gap-3">
      ...
      <div className="flex items-center justify-between bg-[white]">
        ...
        <div>
          <Common.Buttons className="btn text-white mb-1 ml-auto flex items-center justify-center bg-main" onClick={()=>setOpen({open:true,data:[],title:"Add Features",edit:true})}>
            Add Features
          </Common.Buttons> 
        </div>
      ...
      {
        open?.open &&(
            <ViewEditdFeatures open={open}setOpen={setOpen}/>
        )
      }
    </div>
  );
